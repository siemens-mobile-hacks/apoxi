...
#if !defined(Auxiliary_NonsharedBinDataDataSource_hpp)
#define Auxiliary_NonsharedBinDataDataSource_hpp

class BinData;
#include <Auxiliary/DataSource.hpp>

class NonsharedBinDataDataSource : public DataSource
{
    typedef DataSource Base;

    public:
        NonsharedBinDataDataSource(const BinData* bin_data);

        virtual ~NonsharedBinDataDataSource();
