...
const UINT8 c_emz_codec_max_num_of_mp3_dec_inst = 1;
...
class EmzMp3Decoder : public AudioDecoder {
    ...
    public:
        ...
        virtual ResultType DecodeBuffer(
        ...
        virtual ResultType SetParameters(
                                            const ParameterType* types_array,
                                            const UINT32* values_array,
                                            UINT8 array_count);

        virtual ResultType GetParameters(
                                            const ParameterType* types_array,
                                            UINT32* values_array,
                                            UINT8 array_count);
    protected:
    ...
    private:
        ...
        virtual ResultType FreeOutputBuffers();
