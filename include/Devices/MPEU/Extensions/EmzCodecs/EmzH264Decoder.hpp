...
const UINT8 c_emz_codec_max_num_of_h264_dec_inst = 1;
...
class EmzH264Decoder : public VideoDecoder {
    ...
    public:
        ...
        virtual ResultType GetNumberOfInitialDecodeOperations(UINT8& operations);
        ...
        virtual ResultType NotifyOutputBufferReleased(const UINT8 HUGE* out_buf);

        virtual ResultType FlushBuffers( CbResult cb_video_decoder_flushed,
                                         void* context);

        virtual ResultType Reset();
