...
#if !defined(Apoxi_Devices_MPEU_DefaultDisplay_hpp)
#define Apoxi_Devices_MPEU_DefaultDisplay_hpp
...
class DefaultDisplay : public Display {
    ...
    private:
        ...
        BOOLEAN m_skipped_buffer_synchronization;
        BOOLEAN m_use_custom_frame_buffer;
        BOOLEAN m_update_frame_buffer;
...
#endif  // Apoxi_Devices_MPEU_DefaultDisplay_hpp
