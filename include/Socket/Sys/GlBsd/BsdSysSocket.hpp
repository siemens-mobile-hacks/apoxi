...
class SysSocket : public SysSocketBase
{
    ...
    public:
        ...
        enum {
            c_pref_stack_size = 3000            // preferred stack size for SocketRxThread
        };
        ...
        INT GetInBufByteCount(UINT &arg) { return ioctl(m_socket, FIONREAD, &arg); }
    ...
    private:
        ...
        static INT PsdLinkDown(const UINT8 nsapi) {
            return 0;
        };
};
