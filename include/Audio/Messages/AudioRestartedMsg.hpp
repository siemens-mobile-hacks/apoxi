...
#if !defined(Apoxi_Audio_AudioRestartedMsg_hpp)
#define Apoxi_Audio_AudioRestartedMsg_hpp
...
/*  ======================================================================
    Class AudioRestartedMsg
    ====================================================================== */

class AudioRestartedMsg : public Message {
    public:
        AudioRestartedMsg(const SharedPtr<AudioActiveReference>& active_reference);
        virtual ~AudioRestartedMsg();
...
#endif // Apoxi_Audio_AudioRestartedMsg_hpp
