...
#if !defined(Apoxi_Audio_AudioSuspendedMsg_hpp)
#define Apoxi_Audio_AudioSuspendedMsg_hpp
...
/*  ======================================================================
    Class AudioSuspendedMsg
    ====================================================================== */

class AudioSuspendedMsg : public Message {
    public:
        AudioSuspendedMsg(const SharedPtr<AudioActiveReference>& active_reference);
        virtual ~AudioSuspendedMsg();
...
#endif // Apoxi_Audio_AudioSuspendedMsg_hpp
