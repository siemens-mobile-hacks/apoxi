...
#if !defined(Apoxi_Audio_AudioResumedMsg_hpp)
#define Apoxi_Audio_AudioResumedMsg_hpp
...
/*  ======================================================================
    Class AudioResumedMsg
    ====================================================================== */

class AudioResumedMsg : public Message {
    public:
        AudioResumedMsg(const SharedPtr<AudioActiveReference>& active_reference);
        virtual ~AudioResumedMsg();
...
#endif // Apoxi_Audio_AudioResumedMsg_hpp
