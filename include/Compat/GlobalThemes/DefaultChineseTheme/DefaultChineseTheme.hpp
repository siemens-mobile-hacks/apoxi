/*  ------------------------------------------------------------------------
    ...
    ------------------------------------------------------------------------ */
#if !defined(Apoxi_DefaultChineseTheme_hpp)
#define Apoxi_DefaultChineseTheme_hpp
...
class DefaultChineseTheme : public Theme {
    public:
        DefaultChineseTheme();
        virtual ~DefaultChineseTheme();
        void Update();
...
extern const DefaultChineseTheme default_chinese_theme;
