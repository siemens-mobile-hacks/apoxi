/*  ------------------------------------------------------------------------
    ...
    ------------------------------------------------------------------------ */
#if !defined(Apoxi_BlackAndWhiteTheme_hpp)
#define Apoxi_BlackAndWhiteTheme_hpp
...
class BlackAndWhiteTheme : public Theme {
    public:
        BlackAndWhiteTheme();
        virtual ~BlackAndWhiteTheme();
...
extern const BlackAndWhiteTheme black_and_white_theme;
