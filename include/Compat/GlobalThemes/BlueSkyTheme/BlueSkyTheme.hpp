/*  ------------------------------------------------------------------------
    ...
    ------------------------------------------------------------------------ */
#if !defined(Apoxi_BlueSkyTheme_hpp)
#define Apoxi_BlueSkyTheme_hpp
...
class BlueSkyTheme : public Theme {
    public:
        BlueSkyTheme();
        virtual ~BlueSkyTheme();
...
extern const BlueSkyTheme blue_sky_theme;
